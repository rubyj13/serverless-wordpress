...
Description: JustVideo is a responsive and mobile-friendly WordPress video theme that allows you to publish videos from various sources.
...
= 1.0.8 = October 17, 2022
* Fixed issues to meet WP.org's requirements

= 1.0.7 = May 27, 2022
* Fixed site background color issue

= 1.0.6 = January 09, 2022
* Fixed PHP warnings

= 1.0.5 = November 19, 2021
* Added style for preformatted content

= 1.0.4 = October 08, 2021
* Fixed CSS for empty post content 

= 1.0.3 = October 07, 2021
* Added admin notice

= 1.0.2 = September 28, 2021
* Fixed custom header image
* Fixed content block title
* Fixed site title & tagline

= 1.0.1 = September 28, 2021
* Fixed iframe tag to meet WP.org's requirements
...
JustVideo WordPress Theme, Copyright 2021 WPEnjoy.com
JustVideo is distributed under the terms of the GNU GPL.
...
JustVideo bundles the following third-party resources:
